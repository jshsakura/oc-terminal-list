...
DESC_LIST = (
    ...
    "STATE 칸의 '?'는 '유휴'가 아니라 '모름'이다 — 그 호스트에 리모트가 설치되지 않아 "
    "우리가 볼 방법이 없다는 뜻이다. '?'를 '안 돌고 있다'로 읽지 말 것."
)
DESC_WHOAMI = (
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "remote_status": {
                    "type": "boolean",
                    "description": (
                        "원격 터미널의 상태까지 채울지. 기본 켜짐이고 값싸다(리모트가 "
                        "밀어 준 것을 읽을 뿐, 호스트를 찌르지 않는다). 끄면 원격은 "
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "remote_status": {
                    "type": "boolean",
                    "description": (
                        "원격 터미널의 상태까지 채울지. 기본 켜짐 — @working 같은 상태 "
                        "주소는 이게 없으면 원격을 통째로 빼먹는다."
                    ),
                },
            },
            "additionalProperties": False,
