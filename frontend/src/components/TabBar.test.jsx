...
describe('TabBar', () => {
  ...
  it('opens the same Settings submenu on mobile instead of direct open', () => {
    ...
    expect(settingsItem.parentElement).toHaveStyle({ backdropFilter: 'blur(24px) saturate(1.18)' });
    expect(settingsItem.parentElement.style.background).toContain('linear-gradient');
