...
export const en = {
    ...
    muxHintHerdr: 'herdr keeps your session alive when you disconnect. Install it from Tools if the host does not have it; until then the host opens as a plain shell.',
    ...
    defaultMultiplexer: 'Default for new hosts',
    defaultMultiplexerHint: 'What a newly registered host starts with. Each host can override it.',
