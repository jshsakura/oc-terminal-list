...
export const en = {
    ...
    restartSessionHint: 'Fresh shell — running work ends',
    ...
    restartSessionAtPathHint: 'Fresh shell in a chosen folder',
    ...
    openTerminalHereHint: 'Another one here — this one keeps running',
