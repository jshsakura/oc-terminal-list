...
export const en = {
    ...
    agentSection: 'Cross-terminal commands',
    agentPitchTitle: 'Connect this host so its terminals can talk',
    agentPitchBody: 'This host’s terminals will exchange commands directly with terminals on other machines. Right now it is not connected, so its terminals show “?” for status and cannot receive commands.',
    agentBenefitSend: 'Send a command from another terminal to this host — and its agent replies straight back',
    agentBenefitStatus: 'See what this host’s terminals are doing (working · waiting for you · idle)',
    agentBenefitNotify: 'Get a Telegram or web push when a task finishes',
    agentPitchFoot: 'What gets installed: a few files under this host’s home (the itl command plus the remote) and one user service. No new port is opened, and it uses a credential scoped to this host. Removable at any time.',
    agentReady: 'Connected — commands flow to and from this host’s terminals',
    ...
    remoteNotInstalledChip: 'Remote not installed',
    remoteInstallFailed: 'Install failed',
    remoteWhyInstall: "Remote not installed — tap to install. With it, you get Telegram/push alerts when this host's agent finishes, and other terminals can send commands here.",
    ...
    remoteReinstall: 'Reinstall',
    remoteInstalling: 'Installing…',
    remoteUninstall: 'Remove',
    remoteUninstallConfirm: 'Really remove — credentials revoked too',
    remoteRemoving: 'Removing…',
