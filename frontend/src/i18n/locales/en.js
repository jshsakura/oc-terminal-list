...
export const en = {
    ...
    helpToolsDesc: 'The 📦 button on a host card (or on this server) opens the install list. herdr ships as the one built-in entry; everything else you add yourself — this app does not decide what belongs on your machines.',
