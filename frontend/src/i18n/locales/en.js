...
export const en = {
    ...
    llmCostNote: 'List-price estimate — not your bill on a flat-rate plan',
    ...
    llmWatcherEnableHint: 'Reads llm-watcher on this server and your hosts. Off means nothing is queried at all.',
    llmWatcherUrl: 'Watcher address (optional)',
    llmWatcherUrlHint: 'Leave empty to auto-detect: llm-watcher:34318 (compose), then 127.0.0.1:34318.',
    llmWatcherApiKey: 'API key (optional)',
    llmWatcherKeyHint: 'Only needed if the watcher runs with LLMW_API_KEY set.',
    llmWatcherKeySet: 'A key is saved. Type a new one to replace it, or clear it below.',
    llmWatcherInstallHint: 'Each host needs llm-watcher running on its loopback:',
