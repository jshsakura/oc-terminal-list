...
const fontSize = {
  /* 스케일에 없는 키를 쓰면 값이 undefined 가 되어 **상속 크기(브라우저 기본 16px)** 로
     렌더된다 — 작게 하려던 라벨이 도리어 제일 커진다. 코드가 계속 '10' 을 찾았으므로
     스케일에 들인다. 대신 여기 없는 치수는 쓰지 않는다(tokens.fontSize.test.js 가 지킨다). */
  '10': '10px',  // micro label — 조밀한 보조 라벨 전용(본문 금지)
  '11': '11px',  // micro caption
  '12': '12px',  // small label
  '13': '13px',  // 본문 표준
  '14': '14px',  // 본문 강조 / 버튼
  '16': '16px',  // 섹션 타이틀
  '18': '18px',  // 로그인/초기설정 타이틀
  '20': '20px',  // 페이지 타이틀
